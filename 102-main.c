...
int main(void)
{
	...
	root->left->left->right = binary_tree_node(root->left->right, 70);
	binary_tree_print(root);
	complete = binary_tree_is_complete(root);
	printf("Is %d complete: %d\n", root->n, complete);

	root->left->right->right = binary_tree_node(root->left->right, 77);
	binary_tree_print(root);
	complete = binary_tree_is_complete(root);
	printf("Is %d complete: %d\n", root->n, complete);

	root->right->left->right = binary_tree_node(root->right->left, 50);
	binary_tree_print(root);
	complete = binary_tree_is_complete(root);
	printf("Is %d complete: %d\n", root->n, complete);
